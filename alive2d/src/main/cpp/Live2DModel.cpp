...
extern "C"
JNIEXPORT void JNICALL
Java_com_arkueid_alive2d_Live2DModel_nativeSetDefaultExpression(JNIEnv *env, jclass clazz,
                                                                jlong handle,
                                                                jstring expression_id) {
    const char *expression_id_str = env->GetStringUTFChars(expression_id, nullptr);
    GetModel(handle)->SetDefaultExpression(expression_id_str);
    env->ReleaseStringUTFChars(expression_id, expression_id_str);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_arkueid_alive2d_Live2DModel_nativeSetFadeOutExpression(JNIEnv *env, jclass clazz,
                                                                jlong handle, jstring expression_id,
                                                                jfloat fade_out_millis) {
    const char *expression_id_str = env->GetStringUTFChars(expression_id, nullptr);
    GetModel(handle)->SetFadeOutExpression(expression_id_str, fade_out_millis);
    env->ReleaseStringUTFChars(expression_id, expression_id_str);
}
extern "C"
JNIEXPORT void JNICALL
