...
public class Live2DModel {
    ...
    private static native void nativeSetDefaultExpression(long handle, String expressionId);

    private static native void nativeSetFadeOutExpression(long handle, String expressionId, float fadeOutMillis);
    ...
    public void setParameterValueById(String paramId, float value, float weight) {
        nativeSetParameterValueById(nativeHandle, paramId, value, weight);
    }

    public void setParameterValueById(String paramId, float value) {
        setParameterValueById(paramId, value, 1.0f);
    }
    ...
    public void addParameterValueById(String paramId, float value) {
    ...
    public void setPartScreenColor(int index, float r, float g, float b, float a) {
        nativeSetPartScreenColor(nativeHandle, index, r, g, b, a);
    }

    public void setPartMultiplyColor(int index, float r, float g, float b, float a) {
        nativeSetPartMultiplyColor(nativeHandle, index, r, g, b, a);
    }
    ...
    public void setDefaultExpression(String expressionId) {
        nativeSetDefaultExpression(nativeHandle, expressionId);
    }

    public void setFadeOutExpression(String expressionId, float fadeOutMillis) {
        nativeSetFadeOutExpression(nativeHandle, expressionId, fadeOutMillis);
    }
